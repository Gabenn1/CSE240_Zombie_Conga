...
Name: Gabriel Clark
Date: 12/01/23
Description: Zombie Conga Main
Usage: ./exe <-s> <seed number> <-EC>
*/
#include <cstring>
#include <time.h>
#include <iostream>
...
int main(int argc, char *argv[])
{
  ...
  {
    cout << "I didnt get this to work but you look nice today";
    // zombieFight();
    return 0;
  }
...
void congaGame(int rounds)
{
  ...
  while (currentRound < rounds)
  {
    ...
    // Print game outline
    cout << endl;
    cout << "New Zombie: " << "[" << newZombie << "]"  << " -- Action: " << "[" << roundName << "]" << endl;
